export function resetPasswordEmailTemplate(firstName, resetUrl) {
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
      <div style="background: linear-gradient(to right, #B67B0F, #100101); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
            <img src="https://res.cloudinary.com/dwkpeu5ra/image/upload/v1743681654/eggys-place-logo_qzwxgs.png" alt="Eggys-place logo" style=""max-width: 50.3px; max-height: 43.92px;" margin-bottom: 20px;border-radius: 10px;">
      ...
      <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        ...
        <p>Best regards,<br>Eggys-place Team</p>
      </div>
    </body>
    </html>
