...
import emailIcon from "../assets/emailIcom.svg";
        ...
        <section className="md:flex justify-between items-start md:gap-6 space-y-10 md:space-y-0">
          ...
          <div>
            <div className="flex items-center mb-4">
              <h1 className="text-2xl font-bold text-[#FFFFFF] p-2 rounded-full bg-[#4BA586]">BH</h1>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-[16px] font-light " onClick={() => (window.location.href = "/")}>
